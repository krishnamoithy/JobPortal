...
<!-- Mirrored from themesbrand.com/steex/layouts/auth-pass-reset.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 May 2023 07:47:38 GMT -->
<head>

    <meta charset="utf-8">
    <title>Reset Password | Steex - Admin & Dashboard Template</title>
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link collapsed" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ph-gauge"></i> <span data-key="t-dashboards">Project Details</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-analytics"> Total </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-crm"> Faild </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-ecommerce"> Complete  </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-learning"> Pending  </a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link" data-key="t-real-estate"> Customers Review </a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('calendar') }}" class="nav-link menu-link"> <i class="ph-calendar"></i> <span data-key="t-calendar">Calendar</span> </a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('chat') }}" class="nav-link menu-link"> <i class="ph-chats"></i> <span data-key="t-chat">Chat</span> </a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('email') }}" class="nav-link menu-link"> <i class="ph-envelope"></i> <span data-key="t-email">Email</span> </a>
                </li>



                <li class="nav-item">
                    <a href="{{ route('filemanagement') }}" class="nav-link menu-link"> <i class="ph-folder-open"></i> <span data-key="t-file-manager">File Manager</span> </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('login') }}" class="nav-link" role="button" data-key="t-signin"> Sign In </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('register') }}" class="nav-link" role="button" data-key="t-signup"> Sign Up </a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('passreset') }}" class="nav-link" role="button" data-key="t-password-reset">
                                    Password Reset
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="{{ route('logout') }}" class="nav-link" role="button" data-key="t-logout"> Logout </a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<!-- Mirrored from themesbrand.com/steex/layouts/auth-pass-reset.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 May 2023 07:47:39 GMT -->
</html>
