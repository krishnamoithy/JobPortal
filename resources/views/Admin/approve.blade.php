        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('approved') }}" class="nav-link" data-key="t-analytics">Approved </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('employer') }}" class="nav-link" data-key="t-crm">Employer</a>
                        </li>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link collapsed" href="#sidebarAuth" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth">
                    <i class="ph-user-circle"></i> <span data-key="t-authentication">User Details</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarAuth">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('employee') }}" class="nav-link" role="button" data-key="t-password-reset">
                             employee Details
                            </a>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('employer') }}" class="nav-link" role="button" data-key="t-password-create">
                            Employer Details
                            </a>
                            </li>
                  ...
                  <tr>
                    ...
                    <td>
                        <form method="post" action="{{route('empapprove')}}">
                            @csrf
                        <input name="employer_id" type="hidden" value="{{$user->id}}">
