...
<section class="loginForm employer-login">
    <div class="container-fluid">
				...
				<div class="col-md-7">
					<div class="login-sec">
						<div class="text-center">
							...
							<h4 class="text-red">Please Login to Your Company Account</h4>
						</div>
							...
							<div class="row justlogin">
								<div class="col d-flex justify-content-left">
									<!-- Checkbox -->
									<div class="form-check">
									<div class="checkbox m-0">
										<input type="checkbox" name="savepassword" class="form-check-input" id="savePwd" checked required>
										<label class="form-check-label p-1" for="savePwd">Save Password</label>
									</div>
									</div>
								</div>
							...
							<!-- Register buttons -->
							<div class="text-center">
								<p>Don't have Account? <a class="clickHere" href="{{ route('register') }}">Register Here</a></p>
							</div>
						</form>
					</div>
				</div>
				<div class="col-md-5 banner-sec">
					<img class="d-block img-fluid w-100 h-100" src="assets/images/team-meeting.png" alt="Banner">
				</div>
			</div>
		</div>
	</div>
...
<!-- Mirrored from ocsolutions.co.in/html/jobportal/new/employer-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Jun 2023 08:36:06 GMT -->
</html>
